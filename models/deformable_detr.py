...
class SetCriterion(nn.Module):
    ...
    """
    def __init__(self, num_classes, matcher, weight_dict, ref_weight_dict, losses, focal_alpha=0.25):
...
def build(args):
    ...
    criterion = SetCriterion(num_classes, matcher, weight_dict, ref_weight_dict, losses, focal_alpha=args.focal_alpha)
    criterion.to(device)
